...
export function getPhase0Sequence(url: string): SimulationStep[] {
  return [
    ...
    { type: "outputCard", data: { type: "product_analysis", data: mockProductData } as OutputCard },
    { type: "whatsNext", data: { icon: "⚔️", title: "Next: Competitive Landscape", desc: "Researching your top competitors." } },
    { type: "wait", data: 600 },
    ...
    { type: "outputCard", data: { type: "competitive_landscape", data: mockCompetitiveData } as OutputCard },
...
export function getPhase1Sequence(feedback: string): SimulationStep[] {
  return [
    ...
    { type: "whatsNext", data: { icon: "📊", title: "Next: Your Numbers", desc: "Share your funnel metrics for diagnosis." } },
...
export function getPhase2Sequence(numbers: string): SimulationStep[] {
  return [
    ...
    { type: "outputCard", data: { type: "funnel_diagnosis", data: mockFunnelData } as OutputCard },
    { type: "whatsNext", data: { icon: "📋", title: "Next: Work Statement", desc: "Building your 1-month growth plan." } },
    { type: "wait", data: 600 },
    ...
    { type: "outputCard", data: { type: "work_statement", data: mockWorkStatementData } as OutputCard },
    { type: "whatsNext", data: null },
